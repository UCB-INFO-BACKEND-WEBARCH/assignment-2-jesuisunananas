# Assignment 2 Grading: rewariarjun

**Final Score: 99/100 (A+)**

## Summary
- Database Models: 19/20
...
❌ **DB-02**: Category model with unique name constraint
   ...
   - Deduction: POST /categories returns 201 but response missing category object (-1 pts, minor)
...
- Category model with unique name constraint: POST /categories returns 201 but response missing category object
